...
\]
where $\alpha_1$ again adjusts the intensity and $\alpha_2\in[-1,\infty)$ is an interaction parameter. This is called *product*-shot-noise, following Jalilian et al. 2015. Some details:
